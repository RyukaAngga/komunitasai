...
export function AllReports() {
  ...
  // Load unique filter options once on mount to avoid dynamic dropdown option resetting
  useEffect(() => {
          ...
          <div className="relative md:col-span-2">
            <select 
              ...
              onChange={(e) => {
                ...
                setCityFilter('all') // Reset city
                setDistrictFilter('all') // Reset district
              }}
              className="w-full h-10 pl-3 pr-10 bg-zinc-900/40 border border-zinc-900 focus:border-zinc-800 rounded-xl text-xs text-zinc-300 focus:outline-none transition-all cursor-pointer font-sans appearance-none"
            >
            ...
            >
              ...
              {cities
                .filter(city => {
                  ...
                  return reports.some(r => r.province === provinceFilter && r.city === city)
                })
                .map(city => (
            ...
            >
              ...
              {districts
                .filter(dist => {
                  ...
                  return reports.some(r => r.city === cityFilter && r.district === dist)
                })
                .map(dist => (
